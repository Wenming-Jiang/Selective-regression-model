...
if __name__ == '__main__':
    ...
    parser.add_argument("-P", "--datapath", type=str, default="../Data/TCIR-ATLN_EPAC_WPAC.h5", help="the TCIR dataset file path")
    parser.add_argument("-Tx", "--trainset_xpath", type=str, default="../Data/ATLN_2003_2014_data_x_101.npy", help="the trainning set x file path")
    parser.add_argument("-Ty", "--trainset_ypath", type=str, default="../Data/ATLN_2003_2014_data_y_101.npy", help="the trainning set y file path")
    parser.add_argument("-Tex", "--testset_xpath", type=str, default="../Data/ATLN_2015_2016_data_x_101.npy", help="the test set x file path")
    parser.add_argument("-Tey", "--testset_ypath", type=str, default="../Data/ATLN_2015_2016_data_y_101.npy", help="the test set y file path")
    args = parser.parse_args()
    
    Separate(args.datapath, args.trainset_xpath, args.trainset_ypath, args.testset_xpath, args.testset_ypath)
