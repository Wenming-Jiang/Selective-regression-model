...
def draw_dy_sample():
	...
	plt.savefig('./Figure/age_dy_sample.eps')
	plt.savefig('./Figure/age_dy_sample.png')
	plt.show()
...
def TC_draw_dy_sample():
	...
	plt.savefig('./Figure/TC_dy_sample.eps')
	plt.savefig('./Figure/TC_dy_sample.png')
	plt.show()
...
def TC_testmse_testb_idealmse(row, col, num, fig):
	...
	#styles=['normal','italic','oblique']
    #weights=['light','normal','medium','semibold','bold','heavy','black']
	ax.set_xlabel("coverage", fontdict = font1, horizontalalignment='center' )#x轴上的名字
	ax.set_ylabel("risk(MSE)", fontdict = font1, verticalalignment ='center')#y轴上的名字
...
def AGE_testmse_testb_idealmse(row, col, num, fig):
    ...
    #weights=['light','normal','medium','semibold','bold','heavy','black']
	ax.set_xlabel("coverage", fontdict = font1, horizontalalignment='center' )#x轴上的名字
	ax.set_ylabel("risk(MAE)", fontdict = font1, verticalalignment ='center')#y轴上的名字
